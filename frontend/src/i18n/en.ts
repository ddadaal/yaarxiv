  ...
  pages: {
    upload: {
      ...
      info: {
        ...
        articleTitleCn: "Chinese Title (max chars: {})",
        keywordsCn: "Chinese Keywords (max chars per item: {})",
        articleTitleEn: "English Title (max chars: {})",
        keywordsEn: "English Keywords (max chars per item: {})",
