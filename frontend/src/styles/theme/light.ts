...
const lightTheme: ThemeType = {
  "global": {
    ...
    "breakpoints": {
      ...
      "medium": { "value": breakpoints.md },
      "large": { "value": breakpoints.lg },
    },
    "deviceBreakpoints": {
      "phone": "small",
      "tablet": "medium",
  ...
  "box": {
    "responsiveBreakpoint": "small",
    "extend": (props) => ({ opacity: props.theme.global.opacity[props.opacity] }),
  },
  "button": {
    "border": {
      "width": "2px",
    ...
    "primary": {},
    "disabled": { "extend": (props) => ({ opacity: props.theme.global.opacity.medium }) },
    "minWidth": "96px",
    "maxWidth": "384px",
    "padding": {
      "vertical": "4px",
